...
describe('useFixedAssets', () => {
    ...
    describe('useTransferFixedAsset', () => {
        it('should transfer fixed asset', async () => {
            ...
            result.current.mutate({ id: '1', data: { to_department_id: '2', transfer_date: '2023-01-01' } })
    ...
    describe('useDepreciateFixedAsset', () => {
        it('should depreciate fixed asset', async () => {
            ...
            result.current.mutate({ id: '1', data: { depreciation_date: '2023-01-01', depreciation_amount_cents: 100 } })
