...
describe('useEmployees', () => {
    ...
    describe('useEmployees', () => {
        it('should fetch employees with filters', async () => {
            ...
            const { result } = renderHook(() => useEmployees({ status: 'active', active_only: true }), {
            ...
            expect(apiClient.get).toHaveBeenCalledWith(expect.stringContaining('active_only=true'))
        })
    })
    ...
    describe('useRegularizeEmployee', () => {
        it('should call regularize api', async () => {
            ...
            result.current.mutate({ id: '1', data: { regular_date: '2023-01-01' } })
