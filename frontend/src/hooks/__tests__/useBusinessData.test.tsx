...
import { useAccounts, useExpenseCategories, useEmployees } from '../useBusinessData'
...
describe('useBusinessData', () => {
    ...
    // 注意: useCurrencies 测试已移至 business/__tests__/useCurrencies.test.tsx
    // 注意: useDepartments 测试已移至 business/__tests__/useDepartments.test.tsx
