  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text: string, record: any) => (
        <Space direction="vertical" size={0}>
          <span>{text || '系统'}</span>
          {record.actor_email && <span style={{ fontSize: 12, color: '#999' }}>{record.actor_email}</span>}
        </Space>
      )
    },
    {
    ...
    },
    {
      ...
      render: (text: string, record: any) => (
        <Space direction="vertical" size={0}>
          <span>{text || '-'}</span>
          {record.ip_location && <span style={{ fontSize: 12, color: '#999' }}>{record.ip_location}</span>}
        </Space>
      )
    }
  ]
