...
describe('Audit Routes', () => {
    ...
    it('should get audit logs', async () => {
        ...
        expect(mockAuditService.getAuditLogs).toHaveBeenCalledWith(expect.objectContaining({ limit: 10 }))
    })
    ...
    it('should export audit logs', async () => {
        const mockResult = {
            results: [
                { id: '1', action: 'create', at: 1234567890, actorName: 'Test User', actorEmail: 'test@example.com', entity: 'user', entityId: 'u1', ip: '127.0.0.1', ipLocation: 'Local', detail: 'Created user' }
            ],
            total: 1
        }
        mockAuditService.getAuditLogs.mockResolvedValue(mockResult)
