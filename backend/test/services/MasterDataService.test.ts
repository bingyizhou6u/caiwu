...
describe('MasterDataService', () => {
    ...
    describe('Accounts', () => {
        it('should create and get accounts', async () => {
            ...
            const acc = await service.createAccount({ name: 'Bank 1', type: 'bank', currency: 'CNY', openingCents: 1000 })
    ...
    describe('Positions', () => {
        it('should get positions', async () => {
            ...
            await db.insert(schema.positions).values({
                id: 'pos1', code: 'P1', name: 'Dev', level: 2, functionRole: 'developer', active: 1
            }).execute()
    ...
    describe('OrgDepartments', () => {
        it('should get org departments', async () => {
            ...
            await db.insert(schema.orgDepartments).values({
                id: 'od1', name: 'Tech', active: 1
            }).execute()
