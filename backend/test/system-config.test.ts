...
describe('System Config API', () => {
    ...
    async function request(path: string, method: string, body?: any, headers: Record<string, string> = {}) {
    ...
    it('GET /api/system-config/email-notification/enabled should return true', async () => {
