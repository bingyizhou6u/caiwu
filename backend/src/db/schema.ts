...
export const employees = sqliteTable('employees', {
    ...
    probationSalaryCents: integer('probation_salary_cents'),
    regularSalaryCents: integer('regular_salary_cents'),
    livingAllowanceCents: integer('living_allowance_cents'),
    housingAllowanceCents: integer('housing_allowance_cents'),
    transportationAllowanceCents: integer('transportation_allowance_cents'),
    mealAllowanceCents: integer('meal_allowance_cents'),
    status: text('status'),
    active: integer('active').default(1),
    phone: text('phone'),
...
export const allowancePayments = sqliteTable('allowance_payments', {
    id: text('id').primaryKey(),
    employeeId: text('employee_id').notNull(),
