...
| **EmptyText** | 20 | **34%** | ⚠️ 中等 | ↗️ 提升中 |
| **SearchFilters** | 23 | **39%** | ⚠️ 中等 | ↗️ 提升中 |
| **StatusTag** | 17 | **29%** | ⚠️ 中等 | ↗️ 提升中 |
...
| 组件名 | 使用页面数 | 覆盖率 | 状态 | 趋势 |
|--------|-----------|--------|------|------|
| **AmountInput** | 12 | **20%** | ⚠️ 中等 | ↗️ 提升中 |
| **CurrencySelect** | 12 | **20%** | ⚠️ 中等 | ↗️ 提升中 |
| **AccountSelect** | 9 | **15%** | ⚠️ 低 | ↗️ 提升中 |
| **EmployeeSelect** | 4 | **7%** | ⚠️ 低 | ↗️ 提升中 |
| **DepartmentSelect** | 1 | **2%** | ⚠️ 极低 | ↗️ 提升中 |
| **VendorSelect** | 0 | **0%** | ❌ 未使用 | → 待推广 |

**Form 组件总体覆盖率**: **11%** (12个页面使用 / 59个页面)

### 独立组件

| 组件名 | 使用页面数 | 覆盖率 | 状态 | 趋势 |
|--------|-----------|--------|------|------|
| **FormModal** | 30 | **51%** | ✅ 良好 | ↗️ 提升中 |
| **SensitiveField** | 2 | **3%** | ⚠️ 极低 | ↗️ 提升中 |
...
|---------|-----------|-----------------|-----------------|------|
| **Common 组件** | 59% | 70%+ | 80%+ | 🟡 进行中 |
| **Form 组件** | 16% | 30%+ | 50%+ | 🟡 进行中 |
| **独立组件** | 15% | 30%+ | 50%+ | 🟡 进行中 |
| **整体覆盖率** | **45%** | **60%+** | **70%+** | 🟡 进行中 |
